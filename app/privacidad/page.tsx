...
export default function PrivacyPage() {
  return <main className="info-page">
    ...
    <article>
      ...
      <p>Los anuncios permanecen desactivados mientras se completa la configuración. Si se activa Google AdSense, Google y otros proveedores podrán utilizar cookies para mostrar, limitar y medir anuncios. Los visitantes podrán administrar la personalización desde la configuración de anuncios de Google y los controles de consentimiento que correspondan a su ubicación.</p>
